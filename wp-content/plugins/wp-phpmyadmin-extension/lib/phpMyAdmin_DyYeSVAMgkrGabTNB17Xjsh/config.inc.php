...
$cfg['blowfish_secret']					= 'j&!Z:-i`ob,i\"Fu*:V?>`=wknR-Fj=U`' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_DyYeSVAMgkrGabTNB17Xjsh/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
